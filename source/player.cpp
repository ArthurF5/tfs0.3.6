...
void Player::onAttackedCreatureChangeZone(ZoneType_t zone)
{
	...
	else if(zone == ZONE_NORMAL && g_game.getWorldType() == WORLD_TYPE_NO_PVP && attackedCreature->getPlayer() && !attackedCreature->getPlayer()->isEnemy(this, true))
	{
...
bool Player::isEnemy(const Player* player, bool allies) const
{
	...
	return !warMap.empty() && (((g_game.getWorldType() != WORLD_TYPE_NO_PVP || g_config.getBool(
