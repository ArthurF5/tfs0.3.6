...
bool ProtocolHTTP::parseFirstPacket(NetworkMessage& msg)
{
	if(OutputMessage_ptr output = OutputMessagePool::getInstance()->getOutputMessage(this, false))
	{
		...
		output->AddString("Server: The Lost Server httpd/0.4\r\n");
		...
		output->AddString("\r\n");
		output->AddString("<html><head><title>The Lost Server httpd</title></head><body>It works (apache ripoff ;D)!</body></html>");
